...
add_post_type_support('re-product','excerpt');
...
function redev_scripts() {
	...
	wp_enqueue_style( 'developr-fontawesome', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.1/css/all.min.css', array(), _S_VERSION );
...
require get_stylesheet_directory() . '/inc/reDev-Customizer.php';
new reDev_customizer();
/**
